...
async function main(){
  ...
  try{
    ...
    await pool.query(`CREATE TABLE IF NOT EXISTS dominance_campaign_entities (
      id BIGSERIAL PRIMARY KEY,
      dominance_account_id BIGINT REFERENCES dominance_accounts(id) ON DELETE CASCADE,
      ad_account_id BIGINT REFERENCES dominance_ad_accounts(id) ON DELETE CASCADE,
      platform TEXT NOT NULL,
      entity_type TEXT NOT NULL,
      parent_entity_id BIGINT REFERENCES dominance_campaign_entities(id) ON DELETE CASCADE,
      external_id TEXT,
      name TEXT NOT NULL,
      status TEXT,
      objective TEXT,
    ...
    await pool.query(`CREATE TABLE IF NOT EXISTS dominance_creative_request_outputs (
      id BIGSERIAL PRIMARY KEY,
      request_id BIGINT NOT NULL REFERENCES dominance_creative_requests(id) ON DELETE CASCADE,
